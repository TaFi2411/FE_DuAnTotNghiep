<template>
  <div class="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-gray-100 to-gray-50 text-center px-4">
    <div
    ...
    >
      ...
      <h1 class="text-3xl font-extrabold mb-4" :class="status === 'success' ? 'text-green-700' : 'text-red-700'">
