          ...
          <div class="mb-3">
            ...
            <div class="d-flex gap-4">
              <div class="form-check">
                <input type="radio" class="form-check-input" :value="true" v-model="voucher.type" :class="{ 'is-invalid': v$.type.$error }" />
                <label class="form-check-label">Sản phẩm</label>
              </div>
              <div class="form-check">
                <input type="radio" class="form-check-input" :value="false" v-model="voucher.type" :class="{ 'is-invalid': v$.type.$error }" />
